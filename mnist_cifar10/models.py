...
from cleverhans.model import Model  # models inherit from cleverhans' abstract model class
...
class LeNet(Model):
    def __init__(self, nb_classes, input_shape, is_training, bn=False):
        super().__init__()
    ...
    def fprop(self, x, reuse=tf.AUTO_REUSE):
...
class ResNet20_v2(Model):
    def __init__(self, nb_classes, input_shape, is_training, bn=True):
        super().__init__()
        self.nb_classes = nb_classes
        self.input_shape = input_shape
        self.weights_init = 'He'
