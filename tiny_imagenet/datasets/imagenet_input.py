...
def image_preprocessing(image_buffer, bbox, image_size, bounds, is_training):
...
def imagenet_parser(value, image_size, bounds, is_training):
...
def imagenet_input(split, batch_size, image_size, bounds, is_training):
  ...
  dataset = dataset.apply(
      tf.contrib.data.map_and_batch(
          lambda value: imagenet_parser(value, image_size, bounds, is_training),
